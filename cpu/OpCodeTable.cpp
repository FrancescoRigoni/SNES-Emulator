...
OpCode Cpu::OP_CODE_TABLE[] = {
    ...
    OpCode(0x5B, "TCD", Implied,                                        &Cpu::executeTDCTCD),
    ...
    OpCode(0x7B, "TDC", Implied,                                        &Cpu::executeTDCTCD),
    ...
    OpCode(0xA8, "TAY", Implied,                                        &Cpu::executeTAXTAY),
    OpCode(0xA9, "LDA", Immediate),
    OpCode(0xAA, "TAX", Implied,                                        &Cpu::executeTAXTAY),
