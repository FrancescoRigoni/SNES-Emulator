...
OpCode Cpu::OP_CODE_TABLE[] = {
    ...
    OpCode(0x06, "ASL", DirectPage,                                     &Cpu::executeASL),
    ...
    OpCode(0x16, "ASL", DirectPageIndexedWithX,                         &Cpu::executeASL),
    ...
    OpCode(0x1B, "TCS", Implied,                                        &Cpu::executeTransfer),
    OpCode(0x1C, "TRB", Absolute),
    OpCode(0x1D, "ORA", AbsoluteIndexedWithX,                           &Cpu::executeORA),
    OpCode(0x1E, "ASL", AbsoluteIndexedWithX,                           &Cpu::executeASL),
    OpCode(0x1F, "ORA", AbsoluteLongIndexedWithX,                       &Cpu::executeORA),
    OpCode(0x20, "JSR", AbsoluteProgram),
    OpCode(0x21, "AND", DirectPageIndexedIndirectWithX,                 &Cpu::executeAND),
    OpCode(0x22, "JSR", AbsoluteLong),
    OpCode(0x23, "AND", StackRelative,                                  &Cpu::executeAND),
    OpCode(0x24, "BIT", DirectPage),
    OpCode(0x25, "AND", DirectPage,                                     &Cpu::executeAND),
    OpCode(0x26, "ROL", DirectPage,                                     &Cpu::executeROL),
    OpCode(0x27, "AND", DirectPageIndirectLong,                         &Cpu::executeAND),
    OpCode(0x28, "PLP", StackImplied,                                   &Cpu::executeStack),
    OpCode(0x29, "AND", Immediate,                                      &Cpu::executeAND),
    OpCode(0x2A, "ROL", Accumulator,                                    &Cpu::executeROL),
    OpCode(0x2B, "PLD", StackImplied,                                   &Cpu::executeStack),
    OpCode(0x2C, "BIT", Absolute),
    OpCode(0x2D, "AND", Absolute,                                       &Cpu::executeAND),
    OpCode(0x2E, "ROL", Absolute,                                       &Cpu::executeROL),
    OpCode(0x2F, "AND", AbsoluteLong,                                   &Cpu::executeAND),
    OpCode(0x30, "BMI", ProgramCounterRelative),
    OpCode(0x31, "AND", DirectPageIndirectIndexedWithY,                 &Cpu::executeAND),
    OpCode(0x32, "AND", DirectPageIndirect,                             &Cpu::executeAND),
    OpCode(0x33, "AND", StackRelativeIndirectIndexedWithY,              &Cpu::executeAND),
    OpCode(0x34, "BIT", DirectPageIndexedWithX),
    OpCode(0x35, "AND", DirectPageIndexedWithX,                         &Cpu::executeAND),
    OpCode(0x36, "ROL", DirectPageIndexedWithX,                         &Cpu::executeROL),
    OpCode(0x37, "AND", DirectPageIndirectLongIndexedWithY,             &Cpu::executeAND),
    OpCode(0x38, "SEC", Implied,                                        &Cpu::executeStatusReg),
    OpCode(0x39, "AND", AbsoluteIndexedWithY,                           &Cpu::executeAND),
    OpCode(0x3A, "DEC", Accumulator),
    OpCode(0x3B, "TSC", Implied,                                        &Cpu::executeTransfer),
    OpCode(0x3C, "BIT", AbsoluteIndexedWithX),
    OpCode(0x3D, "AND", AbsoluteIndexedWithX,                           &Cpu::executeAND),
    OpCode(0x3E, "ROL", AbsoluteIndexedWithX,                           &Cpu::executeROL),
    OpCode(0x3F, "AND", AbsoluteLongIndexedWithX,                       &Cpu::executeAND),
    ...
    OpCode(0x5B, "TCD", Implied,                                        &Cpu::executeTransfer),
    ...
    OpCode(0x7B, "TDC", Implied,                                        &Cpu::executeTransfer),
    ...
    OpCode(0x8A, "TXA", Implied,                                        &Cpu::executeTransfer),
    ...
    OpCode(0x98, "TYA", Implied,                                        &Cpu::executeTransfer),
    OpCode(0x99, "STA", AbsoluteIndexedWithY,                           &Cpu::executeSTA),
    OpCode(0x9A, "TXS", Implied,                                        &Cpu::executeTransfer),
    OpCode(0x9B, "TXY", Implied,                                        &Cpu::executeTransfer),
    ...
    OpCode(0xA0, "LDY", Immediate,                                      &Cpu::executeLDY),
    OpCode(0xA1, "LDA", DirectPageIndexedIndirectWithX,                 &Cpu::executeLDA),
    OpCode(0xA2, "LDX", Immediate,                                      &Cpu::executeLDX),
    OpCode(0xA3, "LDA", StackRelative,                                  &Cpu::executeLDA),
    OpCode(0xA4, "LDY", DirectPage,                                     &Cpu::executeLDY),
    OpCode(0xA5, "LDA", DirectPage,                                     &Cpu::executeLDA),
    OpCode(0xA6, "LDX", DirectPage,                                     &Cpu::executeLDX),
    OpCode(0xA7, "LDA", DirectPageIndirectLong,                         &Cpu::executeLDA),
    OpCode(0xA8, "TAY", Implied,                                        &Cpu::executeTransfer),
    OpCode(0xA9, "LDA", Immediate,                                      &Cpu::executeLDA),
    OpCode(0xAA, "TAX", Implied,                                        &Cpu::executeTransfer),
    OpCode(0xAB, "PLB", StackImplied,                                   &Cpu::executeStack),
    OpCode(0xAC, "LDY", Absolute,                                       &Cpu::executeLDY),
    OpCode(0xAD, "LDA", Absolute,                                       &Cpu::executeLDA),
    OpCode(0xAE, "LDX", Absolute,                                       &Cpu::executeLDX),
    OpCode(0xAF, "LDA", AbsoluteLong,                                   &Cpu::executeLDA),
    OpCode(0xB0, "BCS", ProgramCounterRelative),
    OpCode(0xB1, "LDA", DirectPageIndirectIndexedWithY,                 &Cpu::executeLDA),
    OpCode(0xB2, "LDA", DirectPageIndirect,                             &Cpu::executeLDA),
    OpCode(0xB3, "LDA", StackRelativeIndirectIndexedWithY,              &Cpu::executeLDA),
    OpCode(0xB4, "LDY", DirectPageIndexedWithX,                         &Cpu::executeLDY),
    OpCode(0xB5, "LDA", DirectPageIndexedWithX,                         &Cpu::executeLDA),
    OpCode(0xB6, "LDX", DirectPageIndexedWithY,                         &Cpu::executeLDX),
    OpCode(0xB7, "LDA", DirectPageIndirectLongIndexedWithY,             &Cpu::executeLDA),
    OpCode(0xB8, "CLV", Implied),
    OpCode(0xB9, "LDA", AbsoluteIndexedWithY,                           &Cpu::executeLDA),
    OpCode(0xBA, "TSX", Implied,                                        &Cpu::executeTransfer),
    OpCode(0xBB, "TYX", Implied,                                        &Cpu::executeTransfer),
    OpCode(0xBC, "LDY", AbsoluteIndexedWithX,                           &Cpu::executeLDY),
    OpCode(0xBD, "LDA", AbsoluteIndexedWithX,                           &Cpu::executeLDA),
    OpCode(0xBE, "LDX", AbsoluteIndexedWithY,                           &Cpu::executeLDX),
    OpCode(0xBF, "LDA", AbsoluteLongIndexedWithX,                       &Cpu::executeLDA),
